...
const sections = [
   {
	...
	{title: "PÚBLIC", rowId: `${usedPrefix + command} public`},
...
m.reply(`
el comando *${type}* Se *${isEnable ? 'Active' : 'Deactive'}* ${isAll ? 'pear is bot' : isUser ? '' : 'money is chat'}
con éxitos ✅`.trim()) 
