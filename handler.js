...
this.sendButton(id, text, groupMetadata.subject, apii.data, [[(action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ 👋' : ' ᴀᴅɪᴏs 🚮'), (action == 'add' ? '#welcomegc' : '#byegc')], ['🍡 ᴍᴇɴᴜ 🍡', `#menu`]], null, {mentions: this.parseMention(text)})
